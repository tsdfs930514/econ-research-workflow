...
| 2026-02-28 | Skill audit per skill-creator best practices (Phase 7): Audited all 34 skills + 1 reference doc. 26 skills confirmed Grade A. Updated 8 skills: (1) /translate — removed 2 persona statements, reordered steps (terminology before modes), tightened self-review to checklist, added paper-convention note; (2) /polish — removed 5 persona statements, added mode selection guide table, clarified refine scope, added purpose comments; (3) /de-ai — removed 1 persona statement, added false-positive guidance and context-sensitivity caveat, added CN clean template; (4) /logic-check — added concrete examples, significance borderline and sample size clarifications; (5-8) /explore, /promote, /learn, /robustness — description improvements and template fixes. Updated README, CLAUDE.md, ROADMAP, MEMORY in both EN and CN repos. 16 skill files + 8 doc files = 24 total edits. |
