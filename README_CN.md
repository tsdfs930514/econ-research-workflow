...
- **37 个技能** — 覆盖完整研究生命周期的斜杠命令工作流（数据清洗、DID/IV/RDD/面板/SDID/自举/安慰剂/Logit-Probit/LASSO 估计、交叉验证、表格、论文写作、翻译、润色、去 AI 化改写、逻辑检查、审稿、管线编排、综合报告、CSMAR 数据获取、探索沙盒、会话连续性、苏格拉底式研究工具和自扩展）
